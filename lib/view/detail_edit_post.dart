...
class DetailEditPost extends ConsumerStatefulWidget {
  final Map<String, dynamic> post;

  const DetailEditPost({super.key, required this.post});

  @override
  ConsumerState<DetailEditPost> createState() => _DetailEditPostState();
}

class _DetailEditPostState extends ConsumerState<DetailEditPost> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text(
                        "${widget.post["price"] ?? "2,7 triệu/tháng"}",
                        style: const TextStyle(
                          fontSize: 18,
                          fontWeight: FontWeight.bold,
                          color: Colors.pink,
                  ...
                  const SizedBox(height: 8),
                  Text(
                    "Đăng ${widget.post["date"] ?? "4 ngày trước"}",
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildInfoRow(
                    Icons.key,
                    "Số tiền cọc",
                    "${widget.post["deposit"] ?? "2.700.000 đ/tháng"}",
                  ),
                ],
              ),
            ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text(
                        "SĐT liên hệ: ${widget.post["phone"] ?? "097221****"}",
                      ),
                      const Spacer(),
                      TextButton(
                        onPressed: () {},
